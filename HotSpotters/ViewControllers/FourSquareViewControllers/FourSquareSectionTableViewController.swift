...
class FourSquareSectionTableViewController: UITableViewController {
	...
	// Enum to filter by 'section'
	enum venueSectionMarker {
		static var all = ["Trending", "TopPicks", "Food", "Drinks", "Coffee",
											"Shops", "Arts", "Outdoors", "Sights"]
		
		static var all2: [section] = [("Trending", #imageLiteral(resourceName: "trending")), ("TopPicks", #imageLiteral(resourceName: "topPicks")), ("Food", #imageLiteral(resourceName: "food")),
																	("Drinks", #imageLiteral(resourceName: "drinks")), ("Coffee", #imageLiteral(resourceName: "coffee")), ("Shops", #imageLiteral(resourceName: "shops")),
																	("Arts", #imageLiteral(resourceName: "arts")), ("Outdoors", #imageLiteral(resourceName: "outdoors")), ("Sights", #imageLiteral(resourceName: "sights"))]
	}
	...
	override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		let cell = tableView.dequeueReusableCell(withIdentifier: "sectionCell",
																						 for: indexPath) as! FourSquareSectionTableViewCell
