...
class FourSquareSectionTableViewController: UITableViewController {
    ...
    enum venueSectionMarker {
        ...
        static var all2: [section] = [("Trending", #imageLiteral(resourceName: "topPicks")), ("TopPicks", #imageLiteral(resourceName: "shops")), ("Food", #imageLiteral(resourceName: "food")), ("Drinks", #imageLiteral(resourceName: "drinks")), ("Coffee", #imageLiteral(resourceName: "toa-heftiba-195458-unsplash")), ("Shops", #imageLiteral(resourceName: "trending")), ("Arts", #imageLiteral(resourceName: "adrian-korte-76051-unsplash")), ("Outdoors", #imageLiteral(resourceName: "outdoors")), ("Sights", #imageLiteral(resourceName: "sights"))]
    }
